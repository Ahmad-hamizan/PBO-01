...
public class ListMataKuliah {
    public static void main(String[] args) {
        // buat obj ArrayList dengan generics
        ...
        // set matkul
        m1.setKode("001"); m1.setNama("Bahasa Indonesia");
        m1.setSks(2);
        m2.setKode("002"); m2.setNama("Bahasa Inggris");
        m2.setSks(2);
        m3.setKode("003"); m3.setNama("Matematika Dasar");
        m3.setSks(4);
        // tambahkan ke ArrayList
        mk.add(m1); mk.add(m2); mk.add(m3);
        // cetak
